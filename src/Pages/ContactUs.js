        ...
        <div class="hero-content flex-col lg:flex-row-reverse">
          <div class="text-center px-10  lg:text-left">
            ...
            <p class="py-6 text-center">Have any question or query? Send a message to me.Looking foroward to your important advice.</p>
                        <h1 class="text-xl text-center font-bold text-rose-500">LinkedIn: linkedin.com/in/soroar-mia</h1>
                        <h1 class="text-xl text-center font-bold text-rose-500">Email:miasoroar@gmail.com</h1>
          </div>
          <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 scale-about">
            <div class="card-body">
              ...
              <div class="form-control mt-6">
                ...
                <a class="btn btn-primary w-40">SEND MESSAGE</a>
              </div>
            </div>
          </div>
        </div>
