    ...
    render() {
      ...
      return (
        <div className='p-20 mt-20 '>
          <h2 className='text-4xl  text-fuchsia-700 text-center mb-5'>
            <div class="animation">
              <div class="first"><div>CERTIFICATE OF ACHIEVEMENT</div></div>
              <div class="second"><div>CERTIFICATE OF ACHIEVEMENT</div></div>
              <div class="third"><div>CERTIFICATE OF ACHIEVEMENT</div></div>
            </div>
          </h2>
